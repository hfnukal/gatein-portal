...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/jpp-branding-extension/login/skin/Stylesheet.css"/>
</head>
...
<div class="UILogin">
    ...
    <div class="LoginContent">
        <div class="CenterLoginContent">
            ...
            <% } %>
            <form class="ClearFix" id="loginForm" action="<%= contextPath + "/login"%>" method="post"
                  style="margin: 0px;">
                <table>
...
<p style="font-size: 11px; color: #3f3f3f; text-align: center"><%=res.getString("UILoginForm.label.Copyright")%>
</p>
</body>
</html>
